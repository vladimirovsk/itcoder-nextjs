...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Backend & AI Development Services in Calgary — IT CODER",
    description: "NestJS microservices, REST APIs, AI/LLM integrations, and payment systems for SaaS, fintech and crypto. Senior backend engineer in Calgary.",
  ...
  twitter: {
    ...
    title: "Backend & AI Development Services in Calgary — IT CODER",
    description: "NestJS microservices, REST APIs, AI/LLM integrations, and payment systems for SaaS and fintech. Calgary backend engineer.",
  },
  robots: {
    index: true,
    follow: true,
