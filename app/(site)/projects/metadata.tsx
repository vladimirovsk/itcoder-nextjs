...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: 'https://www.itcoder.ca/projects',
	},
	openGraph: {
		title: 'Our Products — WildLink & SoloBook | IT CODER',
		description: 'WildLink: LoRa mesh tracking for the Canadian Rockies — custom PCB, embedded firmware, real-time CRM. SoloBook: T2125 bookkeeping SaaS for Canadian freelancers.',
